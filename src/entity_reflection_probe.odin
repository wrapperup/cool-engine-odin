...
reflection_probe_init :: proc(probe: ^ReflectionProbe, position: Vec3, half_extents: Vec3) {
	...
	gfx.defer_destroy(&gfx.r_ctx.global_arena, probe.cube_image)
	...
	gfx.defer_destroy(&gfx.r_ctx.global_arena, probe.config)
